...
with open('homogeneos/timeline_duration_08B-MMMM.html', 'r', encoding='utf-8') as f:
    grafico1 = f.read()

with open('intervalos/Group_08B_Timeline.html', 'r', encoding='utf-8') as f:
    grafico2 = f.read()
...
app.layout = html.Div(style={'display': 'flex', 'flex-direction': 'column', 'height': '100vh'}, children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Img(src='/assets/final08B.png', style={'width': '100%', 'height': '100%'})
