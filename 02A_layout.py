...
with open('homogeneos/timeline_duration_02A-MMMM.html', 'r', encoding='utf-8') as f:
    grafico1 = f.read()

with open('intervalos/Group_02A_Timeline.html', 'r', encoding='utf-8') as f:
    grafico2 = f.read()
...
app.layout = html.Div(style={'display': 'flex', 'flex-direction': 'column', 'height': '100vh'}, children=[
    ...
    html.Div([
        ...
        html.Div([
            ...
            html.Img(src='/assets/final02A.png', style={'width': '100%', 'height': '100%'})
        ], style={'flex': '0.8', 'padding': '10px', 'border': '1px solid black'})
